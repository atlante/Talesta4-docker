...
<tr><td>Mot de passe</td><td><input type='password' name='pass1' size='35' maxlength='50' /></td><td><span class='c0'>Le mot de passe  ne communiquer  personne </span></td></tr>
<tr><td>Retappez votre Mot de passe</td><td><input type='password' name='pass2' size='35' maxlength='50' /></td></tr>
<tr><td>email</td><td><input type='text' name='email' size='35' maxlength='80' value='' /></td><td><span class='c0'>Votre E-mail, pour vous prvenir d'actions faites sur votre PJ </span></td></tr>
...
</tr><tr><td>Cat&eacute;gorie d'ge</td><td><select name='id_categorieage'>
	<option value='28'>Enfant</option>
	<option value='29'>Jeune Adulte</option>
	<option value='30'>Adulte expriment</option>
	<option value='31'>Viellard</option>
</select></td><td><span class='c0'>L'ge du PJ, avec les bonus/malus que cela comporte et le background que cela implique</span></td></tr>
...
<td><textarea name='Desc' cols='40' rows='10'></textarea></td><td><span class='c0'>Votre pass, vos projets dans le jeu </span></td></tr>
