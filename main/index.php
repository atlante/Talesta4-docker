...
<p class='justify'>Tout d'abord, allons regarder <a href='./aide_inscription.".$phpExtJeu."'> ici</a> o vous pouvez trouver de l'aide pour cr&eacute;er votre personnage et ainsi &eacute;viter des erreurs qui vous ferez refuser l'acc&egrave;s au jeu</p>";
...
<p class='justify'> Voici les dernires <a href='../news'>actualits</a>  du site.</p>";
...
<p class='justify'>Pour finir, vous pouvez consulter <a href='./joueurs.".$phpExtJeu."'>la liste des personnages prsents ici</a></p>";
