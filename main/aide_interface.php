...
<p><a name='actionsPJ'></a>Voici la liste des differentes actions que peut entreprendre votre personnage. Dans le jeu, &agrave; cot&eacute; de chaque action, apparatra un chiffre qui vous indiquera son cot en PAs (X signifiant que le joueur choisit le nombre de PAs &agrave; utiliser). Il est &eacute;vident que certaines actions ne sont possibles que dans lieux sp&eacute;cifiques</p>
<ul>
...
<ul class='listeTypeNone'>			<li>Chemin Entrer. Se deplacer via les chemins de type Lieu Entrer. Efface les objets temporaires.</li>
						...
						<li>Chemin Guilde. Ncessite le bon mot de passe. Efface les objets temporaires.</li>
						<li>Chemin Aller, Chemin Nager, Chemin Escalader. Le cout est variable en fonction de la distance. Vous serez assug&eacute;ti &agrave; un test de competence pour savoir si vous vous fates aggresser en route (perte de PVs). Efface les objets temporaires.</li>
						<li>Chemin Page. Ncessite de payer. Efface les objets temporaires.</li>
</ul>
</li>
...
<li><span class='c3'>Ramasser Objet</span>: Mettre un objet trouv dans le lieu dans son sac.</li>
...
<li><span class='c3'>Enlever Arme/Armure </span>: Enlever une piece d'armure que l'on porte sur soi ou une arme quipe.</li>
...
<li><span class='c3'>Fouiller Lieu </span>: Essayer de dcouvrir des choses (objets, chemins, persos) caches dans le lieu .</li>
<li><span class='c3'>Se cacher </span>: Essayer de se cacher dans un lieu pour ne plus tre visible dans ce lieu. </li>
<li><span class='c3'>Sortir de l'ombre</span>: Redevenir visible aux personnes prsentes dans le lieu. </li>
<li><span class='c3'>Apprendre</span>: Suivre un enseignement dans une comptence ou une caractristique pour essayer d'augmenter cette carac ou comptence. </li>
<li><span class='c3'>Crer un groupe </span>: Fonder un groupe de PJs dans lequel d'autres PJs pourront vous rejoindre pour vous dplacer ou lutter ensemble par exemple.</li>
<li><span class='c3'>Entrer dans un groupe </span>: Rejoindre un groupe de PJs prsent dans votre lieu.</li>
<li><span class='c3'>Quitter un groupe </span>: Quitter un groupe de PJs pour reprendre votre indpendance.</li>
<li><span class='c3'>Archiver/dsarchiver</span>: Disparatre du jeu le temps d'un cong par exemple. Vous tes invisible au jeu et inversement. Pour les petits malins qui en useraient, il y a des contrles...</li>
...
<tr><td valign='top'>Masse lgre</td><td valign='top'><br /><br /><br /></td><td valign='top'><br /><br /><br /></td></tr>
...
<tr><td valign='top'>Petite Arbalte</td><td valign='top'></td><td valign='top'>&nbsp;</td></tr>
<tr><td valign='top'>Grande Arbalte</td><td valign='top'></td><td valign='top'><br /><br /></td></tr>
...
<tr><td valign='top'>Alphabtisation</td><td valign='top'><br /><br /><br /><br /></td><td valign='top'><br /><br /><br /></td></tr>
