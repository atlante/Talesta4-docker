...
$RCSfile: objetComposantesSort.form.php,v $
*/
...
*/
	...
	$template_main .="<script type='text/javascript'>
		...
		var composanteConservee =' ".getMessage("composanteConservee")."';
		var composanteDetruiteAuLancement=' ".getMessage("composanteDetruiteAuLancement")."';
		
		function ajoutecomposantes(){
			if (document.forms[2].conserve.checked)
				ajoute =  '1';	
			else ajoute = '0';
			chainetemp2 = chainetemp2 + document.forms[2].composantes.options[document.forms[2].composantes.selectedIndex].value+'|'+ajoute+';';
			...
			if (document.forms[2].conserve.checked)
				document.forms[2].ListAdd.options[(document.forms[2].ListAdd.options.length -1)].text =document.forms[2].ListAdd.options[(document.forms[2].ListAdd.options.length -1)].text + composanteConservee;
			else document.forms[2].ListAdd.options[(document.forms[2].ListAdd.options.length -1)].text =document.forms[2].ListAdd.options[(document.forms[2].ListAdd.options.length -1)].text + composanteDetruiteAuLancement;	
			document.forms[0].chaine2.value = chainetemp2;
			document.forms[0].composantesValue.value = document.forms[0].composantesValue.value + 
			'<option value=\''+document.forms[2].composantes.options[document.forms[2].composantes.selectedIndex].value+'\'>' 
			+ document.forms[2].composantes.options[document.forms[2].composantes.selectedIndex].text 
			+ '|' +ajoute + document.forms[0].composantesValue.value + '<\/option>';	
		}
	...
	if ($var[0]>0) {
		...
		if (NOM_SCRIPT<>"supprimer_magie.".$phpExtJeu) {
			...
			$template_main .= $var[1];
			$template_main .= "&nbsp;Composante réutilisable <input type='checkbox' name='conserve' size='4' />";
			$template_main .= "<br /><br />";
