...
$RCSfile: modifier_question.php,v $
*/
...
if($etape==2){
	if($MJ->aDroit($liste_flags_mj["ModifierQuestion"])){
		$SQL = "UPDATE ".NOM_TABLE_QCM." SET ";
...
if($etape=="1"){
	...
	$template_main .= "<br><input type='submit' value='Envoyer' onclick=\"return confirm('Etes vous sur de vouloir modifier cette question ?')\">";
...
if($etape===0){
	$template_main .= "<div class ='centerSimple'><form action='".NOM_SCRIPT."' method='post'>";
	$template_main .= "Quelle question voulez-vous modifier ?<br /><br />";
